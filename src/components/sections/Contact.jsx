...
const Contact = () => {
  ...
  const formspreeFormId = 'mjgannaj'; // TODO: Add your Formspree form ID here
  ...
  const contactMethods = [
    {
      ...
      link: 'mailto:tecotochukwu@gmail.com',
      color: '#6366f1',
      available: '24/7'
    },
    {
    ...
    },
    {
      ...
      value: '@Tochukwu-dev',
      link: 'https://github.com/BensonTochukwu',
      color: '#333',
    ...
    },
    {
      ...
      value: 'Teco-Benson Tochukwu',
      link: 'https://www.linkedin.com/in/tochukwu-teco-benson/',
      color: '#0A66C2',
  ...
  const stats = [
    ...
    { number: '11+', label: 'Projects Delivered', icon: FiCheck },
            ...
            <div className="cta-card">
              <div className="cta-card__content">
                ...
                <p className="cta-card__description">
                  I help bring ideas to life with clean, scalable web applications. 
                  Whether you need a React frontend, a Node.js backend, or a full stack solution, we can make it happen.
                </p>
              ...
              <div className="cta-card__coffee">
                <FiZap />
                <span>Let’s launch your next project together!</span>
              </div>
            </div>
          </div>
        </div>
