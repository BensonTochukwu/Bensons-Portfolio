...
const Hero = () => {
  ...
  const stats = [
    { number: "3+", label: "Years Learning", icon: FiCoffee },
  ...
  const socialLinks = [
    {
      name: "GitHub",
      icon: FiGithub,
      url: "https://github.com/BensonTochukwu",
      color: "#333"
    },
    {
      name: "LinkedIn",
    ...
    },
    {
      name: "Email",
      icon: FiMail,
      url: "mailto:tecotochukwu@gmail.com",
      color: "#ea4335"
    }
  ];
            ...
            <div className="hero__identity">
              <h1 className="hero__name">
                <span className="hero__name-line">
                  <span className="hero__name-text">Teco-Benson</span>
                </span>
                <span className="hero__name-line">
                  <span className="hero__name-text hero__name-text--accent">Tochukwu</span>
                </span>
              </h1>
          ...
          <div className={`hero__visual ${isVisible ? 'hero__visual--visible' : ''}`}>
              ...
              <div className="hero__code-content">
                ...
                <div className="hero__code-line">
                  ...
                  <span className="hero__code-text">
                    ...
                    <span className="hero__code-punctuation">: </span>
                    <span className="hero__code-string">'Teco-Benson Tochukwu'</span>
                    <span className="hero__code-punctuation">,</span>
                  </span>
                </div>
                ...
                <div className="hero__code-line">
                  ...
                  <span className="hero__code-text">
                    ...
                    <span className="hero__code-punctuation">: [</span>
                    <span className="hero__code-string">'JavaScript'</span>
                    <span className="hero__code-punctuation">, </span>
                    <span className="hero__code-string">'React'</span>
                    <span className="hero__code-punctuation">, </span>
                    <span className="hero__code-string">'Node.js'</span>
                    <span className="hero__code-punctuation">],</span>
                  </span>
                </div>
            ...
            <div className="hero__tech">
              ...
              <div className="hero__tech-items">
                {['JavaScript', 'React', 'Node.js', 'Express', 'MongoDB'].map((tech, index) => (
                  <span 
                    key={tech} 
